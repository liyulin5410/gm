...
function logGoldAData(fromTV){
    ...
    function submit(){
        ...
        Ext.Ajax.request({
            url: "http://" + window.location.host + "/logGoldA/board",
            method: 'GET',
            params: args,
    ...
    function drawTable( dataFromServer ){
        ...
        Ext.define('LogDataStruct', {
            ...
            fields: [
                {name: 'GoldAList', type: 'string'},
                {name: 'GoldASource', type: 'string'},
                {name: 'GoldAGold', type: 'string'},
                {name: 'GoldATime', type: 'string'}
            ]
        });
        ...
        function initLogList(){
            var logList = Ext.create('Ext.grid.Panel', {
                ...
                height: 700,
                columns: [
                    {text: '序列', width: 80, dataIndex: 'GoldAList'},
                    {text: '金币来源', width: 80, dataIndex: 'GoldASource'},
                    {text: '获得金币数量', width: 80, dataIndex: 'GoldAGold'},
                    {text: '日期和时间 ', width: 160, dataIndex: 'GoldATime'}
